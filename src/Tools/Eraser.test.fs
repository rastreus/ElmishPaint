...
Vitest.describe (
    ...
    fun () ->
        Vitest.test (
            ...
            fun () ->
                let strokeCanvas = App.Tools.Eraser.beginStroke { X = 10; Y = 10 } Brush1 (blackCanvas ())
        ...
        Vitest.test (
            ...
            fun () ->
                let strokeCanvas = App.Tools.Eraser.beginStroke { X = 20; Y = 20 } Brush2 (blackCanvas ())
        ...
        Vitest.test (
            ...
            fun () ->
                let strokeCanvas = App.Tools.Eraser.beginStroke { X = 30; Y = 30 } Brush4 (blackCanvas ())
        ...
        Vitest.test (
            ...
            fun () ->
                let strokeCanvas = App.Tools.Eraser.beginStroke { X = 40; Y = 40 } Brush8 (blackCanvas ())
        ...
        Vitest.test (
            ...
            fun () ->
                let strokeCanvas = App.Tools.Eraser.beginStroke { X = 0; Y = 0 } Brush1 (blackCanvas ())
