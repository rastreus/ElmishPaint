...
Vitest.describe (
    ...
    fun () ->
        Vitest.test (
            ...
            fun () ->
                let canvas = App.Tools.Line.commit { X = 0; Y = 100 } { X = 511; Y = 100 } (blankCanvas ())
        ...
        Vitest.test (
            ...
            fun () ->
                let canvas = App.Tools.Line.commit { X = 10; Y = 10 } { X = 20; Y = 20 } (blankCanvas ())
        ...
        Vitest.test (
            ...
            fun () ->
                ...
                let previewCanvas = App.Tools.Line.buildPreview { X = 0; Y = 0 } { X = 2; Y = 0 } canvas
